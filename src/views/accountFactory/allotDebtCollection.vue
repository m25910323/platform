	...
	<div class='main clearfix'>
		...
		<div class='search_contain'>
			<div>
				<el-form :inline="true" :model="uploadData" class="demo-form-inline" size="mini" ref='formName'>
					...
					<el-form-item label="收账通知会计" prop="userCode">
		...
		<div class='main_contain clearfix'>
			...
			<el-table :data="tableData" stripe border v-loading='loading'>
				...
				<el-table-column align="center" label="收账通知会计" prop="step6"></el-table-column>
				...
				<el-table-column align="center" label="操作">
					<template slot-scope="scope">
						<el-button type='text' size="mini" @click='commit(scope.row,1)'>分配收账通知</el-button>
					</template>
				</el-table-column>
...
<script>
	export default {
		...
		methods: {
			...
			downloadExcel(){
				window.location.href = '收账通知会计.xls'; 
			},
			exportExcel(){
				window.location.href = '/perTaxToolTwo/e9z/assignment/exportExcel?stepName=6&accountPeriod=' + this.accountPeriod; 
			}
