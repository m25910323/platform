<template>
	<div class='main clearfix'>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>税款确认分配</el-breadcrumb-item>
		</el-breadcrumb>
		<div class='search_contain'>
			<div>
				<el-form :inline="true" :model="uploadData" class="demo-form-inline" size="mini" ref='formName'>
					...
					<el-form-item label="税款确认会计" prop="userCode">
		...
		<div class='main_contain clearfix'>
			...
			<el-table :data="tableData" stripe border v-loading='loading'>
				...
				<el-table-column align="center" label="税款确认会计" prop="step3"></el-table-column>
				...
				<el-table-column align="center" label="操作">
					<template slot-scope="scope">
						<el-button type='text' size="mini" @click='commit(scope.row,1)'>分配税款确认</el-button>
					</template>
				</el-table-column>
...
<script>
	export default {
		...
		methods: {
			...
			downloadExcel(){
				window.location.href = '税款确认会计.xls'; 
			},
			exportExcel(){
				window.location.href = '/perTaxToolTwo/e9z/assignment/exportExcel?stepName=3&accountPeriod=' + this.accountPeriod; 
			}
