<template>
	<div class='main clearfix'>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>客户信息同步改动查询</el-breadcrumb-item>
		</el-breadcrumb>
		...
		<div class='main_contain'>
			...
			<el-table :data="tableData" style="width: 100%;margin-top: 10px;" stripe border v-loading='loading'>
				...
				<el-table-column align="center" label="字段" prop="fieldNameCh"></el-table-column>
				<el-table-column align="center" label="原始值" prop="oldValueCh"></el-table-column>
				<el-table-column align="center" label="修改值" prop='newValueCh'></el-table-column>
	...
	export default {
		...
		methods: {
			...
			queryPage() {
				...
				this.axios.post('/perTaxToolTwo/e9z/historyQuery/getSynchronizationCustomerInfoByPage', params)
					.then(res => {
						this.loading = false;
						if (res.data.code == 200) {
