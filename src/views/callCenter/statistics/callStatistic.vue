<template>
	<div class='main_contain'>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>通话统计</el-breadcrumb-item>
		</el-breadcrumb>
		<div class="contain_body">
			<div style="background: #fff;height:45px;padding:15px 12px 0px;">
				<el-form :inline="true" :model="uploadData" class="demo-form-inline" size="mini" ref='formName' label-width="100px">
					<el-form-item label="按月统计" prop="month">
						<el-date-picker v-model="uploadData.month" align="right" type="month" placeholder="请选择" format="yyyy-MM" value-format="yyyy-MM">
						</el-date-picker>
					</el-form-item>
					<el-form-item label="按日统计" prop="dateTime">
						<el-date-picker v-model="uploadData.dateTime" align="right" type="date" placeholder="请选择" format="yyyy-MM-dd" value-format="yyyy-MM-dd">
						</el-date-picker>
					</el-form-item>
	...
	export default {
		...
		data() {
			return {
				...
				tableList: [],
				cardList:[
					{label:'通话总数',value:'cou'},
					{label:'呼入总数',value:'call1'},
					{label:'呼出总数',value:'call2'},
					{label:'平均通话时长',value:'duration'},
					{label:'呼入平均通话时长',value:'duration1'},
					{label:'呼出平均通话时长',value:'duration2'},
					{label:'接通率',value:'type'},
					{label:'呼入接通率',value:'type1'},
					{label:'呼出接通率',value:'type2'},
					{label:'满意率',value:'score'},
					{label:'呼入满意率',value:'score1'},
					{label:'呼出满意率',value:'score2'},
				],
				legend:['通话总数','呼入总数','呼出总数','呼入接通率','呼出接通率','满意率','解决率'],
				xAxis:[],
		...
		methods: {
			queryListByPage() {
				...
				this.axios.post('/perTaxToolTwo/callCenter/CallLog/statistical', param).then(res => {
					this.loading = false;
			...
			queryList() {
				...
				this.axios.post('/perTaxToolTwo/callCenter/CallLog/statisticalChart', params).then(res => {
			...
			search() {
				...
				this.dateTime = this.uploadData.dateTime;
