	...
	<div class='main_contain'>
		...
		<div class="contain_body">
			...
			<el-table :data="tableList" v-loading='loading' @selection-change="handleSelectionChange">
				...
				<el-table-column align="center" label="客服工号" prop="userId" :resizable="false"></el-table-column>
				<el-table-column align="center" label="客服姓名" prop="userName" :resizable="false"></el-table-column>
				<el-table-column align="center" label="客服部门" prop="departName" :resizable="false"></el-table-column>
				
				<el-table-column align="center" label="分机号" prop="agentPhone" :resizable="false"></el-table-column>
				<el-table-column align="center" label="坐席邮箱" prop="agentEmail" :resizable="false"></el-table-column>
				<el-table-column align="center" label="坐席id" prop="agentId" :resizable="false"></el-table-column>
				
				<el-table-column align="center" label="手机号" prop="phone" :resizable="false"></el-table-column>
				<el-table-column align="center" label="技能组id" prop="agentGroup" :resizable="false"></el-table-column>
				<el-table-column align="center" label="sip话机号" prop="sipPhone" :resizable="false"></el-table-column>
		...
		<el-dialog width="400px" :title="tag == 'edit'?'编辑':'新增'" :visible.sync="dialogVisible" :before-close="handleClose">
			<el-form ref="form" :model="form" label-width="120px" size="mini" label-position="right">
				...
				<el-form-item label="分机号">
					<el-input v-model="form.agentPhone" placeholder="请输入"></el-input>
				</el-form-item>
				<el-form-item label="坐席邮箱">
					<el-input v-model="form.agentEmail" placeholder="请输入"></el-input>
				</el-form-item>
				<el-form-item label="坐席id">
					<el-input v-model="form.agentId" placeholder="请输入"></el-input>
				</el-form-item>
				<el-form-item label="手机号">
					<el-input v-model="form.phone" placeholder="请输入"></el-input>
				</el-form-item>
				<el-form-item label="技能组id">
					<el-input v-model="form.agentGroup" placeholder="请输入"></el-input>
				</el-form-item>
				<el-form-item label="sip话机号">
					<el-input v-model="form.sipPhone" placeholder="请输入"></el-input>
				</el-form-item>
	...
	export default {
		...
		methods: {
			queryListByPage() {
				...
				this.axios.post('/perTaxToolTwo/callcenter/customerServiceConfig/queryListByPage', param).then(res => {
					this.loading = false;
			...
			commit() {
				switch (this.tag) {
					case 'add':
						var url = '/perTaxToolTwo/callcenter/customerServiceConfig/insert';
						break;
					case 'edit':
						var url = '/perTaxToolTwo/callcenter/customerServiceConfig/update'
						break;
				}
				let param = this.form;
			...
			handleDel(index, row) {
				this.$confirm('确定删除?', '提示', {
					...
					let param = [row.configId];
					this.axios.post('/perTaxToolTwo/callcenter/customerServiceConfig/delete', param).then(res => {
						this.loading = false;
						if (res.data.code == 200) {
							this.queryListByPage();
							this.$message({
