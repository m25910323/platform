<template>
	<div class='main_contain'>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>资料领用</el-breadcrumb-item>
		</el-breadcrumb>
		...
		<div class="contain_body clearfix">
			<div>
				...
				<el-table :data="tableList" style="width: 100%" v-loading='loading' @selection-change="handleSelectionChange">
					...
					<!-- <el-table-column align="center" label="持有人" prop="entryDate" :resizable="false"></el-table-column> -->
					...
					<el-table-column align="center" :resizable="false">
						...
						<template slot-scope="scope">
							<el-button size="mini" type="text" @click="handleEdit(scope.$index, scope.row,1)">领用</el-button>
						</template>
					</el-table-column>
				</el-table>
		...
		//单个领用
		<el-dialog title="领用人信息" :visible.sync="dialogVisible" width="4rem" :before-close="reset">
			<el-form ref="form" :model="form2" label-width="100px" size="mini">

				<el-form-item label="用户名">
					<el-input v-model="form2.userCode"></el-input>
				</el-form-item>
		...
		//批量领用
		<el-dialog title="领用人信息" :visible.sync="dialogVisible1" width="4rem" :before-close="reset">
			<el-form ref="form" :model="form1" label-width="100px" size="mini">
		
				<el-form-item label="用户名">
					<el-input v-model="form1.userCode"></el-input>
				</el-form-item>
				<el-form-item label="密码">
					<el-input v-model="form1.pwd"></el-input>
				</el-form-item>
			</el-form>
			<span slot="footer" class="dialog-footer">
...
<script>
	export default {
		...
		methods: {
			...
			commitAddChild() {
				this.form2.moduleIdentification = "MaterialObtain";
			...
			commitAddChild1(){
				this.multipleSelection.forEach(item =>{
					item.moduleIdentification = "MaterialObtain";
					item.userCode = this.form1.userCode;
					item.pwd = this.form1.pwd;
				})
