<template>
	<div class='main clearfix'>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>现金流量调节表B</el-breadcrumb-item>
		</el-breadcrumb>
		...
		<div class='main_contain'>
			...
			<el-table :data="tableData" style="width: 100%;margin-top: 10px;" stripe border v-loading='loading'>
				...
				<el-table-column align="" label="项目" prop="fAsset">
					<template slot-scope="scope">
						<span v-html='scope.row.fAsset'></span>
					</template>
					
				</el-table-column>
				<el-table-column align="center" label="分类项目" prop="fLiabilitiesAndOwnersEquity"></el-table-column>
				<el-table-column align="center" label="分类项目合计" prop='fAmountLeft'></el-table-column>
				<el-table-column align="center" label="合计" prop="fAmountRight"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			queryPage() {
				...
				this.axios.post('/perTaxToolTwo/e9/sheet/getCashFlowRegulationB', params)
