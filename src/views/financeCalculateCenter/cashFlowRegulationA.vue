<template>
	<div class='main clearfix'>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>现金流量调节表A</el-breadcrumb-item>
		</el-breadcrumb>
		...
		<div class='main_contain'>
			...
			<el-table :data="tableData" style="width: 100%;margin-top: 10px;" stripe border v-loading='loading'>
				...
				<el-table-column align="center" label="期末-期初" prop="fAmountLeft"></el-table-column>
				<el-table-column align="" label="项目" prop="fLiabilitiesAndOwnersEquity">
					<template slot-scope="scope">
				...
				<el-table-column align="center" label="期末-期初" prop="fAmountRight"></el-table-column>
			</el-table>
		</div>
	...
	export default {
		...
		methods: {
			...
			queryPage() {
				...
				this.axios.post('/perTaxToolTwo/e9/sheet/getCashFlowRegulationA', params)
