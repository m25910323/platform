<template>
	<div class='main clearfix'>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>会计科目</el-breadcrumb-item>
		</el-breadcrumb>
		...
		<div class='main_contain'>
			...
			<el-table :data="detail" style="width: 100%;margin-top: 12px;" stripe border>
				<el-table-column align="center" label="会计科目编号" prop="fnumber" :resizable="false"></el-table-column>
				<el-table-column align="center" label="会计科目名称" prop="fname" :resizable="false"></el-table-column>
			...
			commitDialog1(formName) {
				this.$refs['ruleForm1'].validate((valid) => {
					if (valid) {
						...
						this.axios
							.post("/perTaxToolTwo/e9/taccount/updateProofAccount", formData)
							.then(res => { //手动上传貌似无法触发成功或失败的钩子函数，因此这里手动调用 
								if (res.data.code == 200) {
									this.reset();
									this.getAssetGroups();
