<template>
	<div class='main clearfix'>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>凭证档案入库</el-breadcrumb-item>
		</el-breadcrumb>
		<div class='search_contain'>
			<div>
				<el-form :inline="true" :model="uploadData" class="demo-form-inline" size="mini" ref='formName'>
					...
					<el-form-item label="凭证所属期" prop="belongDate">
		...
		<div class='main_contain'>
			...
			<el-table :data="tableData" style="width: 100%;margin-top: 10px;" stripe border @selection-change="handleSelectionChange">
				...
				<el-table-column align="center" label="附件张数" prop="customerName"></el-table-column>
				...
				<el-table-column align="center" label="操作">
					<template slot-scope="scope">
						...
						<el-button size="mini" type='text' @click="handleEdit(scope.row)" v-if='scope.row.status != 2'>出库</el-button>
					</template>
				</el-table-column>
			</el-table>
