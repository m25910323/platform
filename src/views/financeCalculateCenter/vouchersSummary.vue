	...
	<div class='main clearfix'>
		...
		<div class='main_contain'>
			...
			<el-table :data="tableData" style="width: 100%;margin-top: 10px;" stripe border v-loading='loading'>
				...
				<el-table-column align="center" label="科目编码" prop="fnumber"></el-table-column>
				<el-table-column align="center" label="科目名称" prop='ffullname'></el-table-column>
				<el-table-column align="center" label="借方金额" prop="ffullNameBorrowAmount"></el-table-column>
				<el-table-column align="center" label="贷方金额" prop="ffullNameLoanAmount"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			queryPage() {
				...
				this.axios.post('/perTaxToolTwo/TVoucherentry/getTVoucherentryInfo', params)
					// this.axios.post('/miaoxing/queryPage', params)
					.then(res => {
						this.loading = false;
						if (res.data.code == 200) {
							this.total = res.data.data.count;
							this.tableData = res.data.data.tvoucherentryList;
							this.tvoucherCount = res.data.data.tvoucherCount;
							this.fattachments = res.data.data.fattachments;
							this.tableData.push({
								fnumber:'',
								ffullname:'合计',
