<template>
	<div class='main clearfix'>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>带薪病假统计表</el-breadcrumb-item>
		</el-breadcrumb>
		...
		<div class='main_contain'>
			...
			<el-table :data="tableData" style="width: 100%;margin-top: 10px;" border v-loading='loading'>
				...
				<el-table-column align="center" label="已休带薪病假" prop="days"></el-table-column>
				<el-table-column align="center" label="未休带薪病假" prop="remainSickLeave"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			queryPage() {
				...
				this.axios.post('/perTaxToolTwo/attendanceapplyholidayController/querySickLeaveList', params)
					.then(res => {
						this.loading = false;
