<template>
	<div class='main clearfix'>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>人员流动统计表</el-breadcrumb-item>
		</el-breadcrumb>
			...
			<div>
				...
				<el-form inline="true" :model="uploadData" class="demo-form-inline" size="small" ref='formName'>
					...
					<el-form-item label="开始日期" prop="startDate">
						<el-date-picker v-model="uploadData.startDate" type="month" placeholder="请选择" format="yyyy-MM" value-format="yyyy-MM">
						</el-date-picker>
					</el-form-item>
					<el-form-item label="结束日期" prop="endDate">
						<el-date-picker v-model="uploadData.endDate" type="month" placeholder="请选择" format="yyyy-MM" value-format="yyyy-MM">
						</el-date-picker>
					</el-form-item>
		...
		<div class='main_contain'>
			...
			<el-table :data="tableData" style="width: 100%;margin-top: 10px;" border v-loading='loading'>
				...
				<el-table-column align="center" label="人数" prop="count"></el-table-column>
			</el-table>
...
<script>
	export default {
		...
		data() {
			return {
				loading: false,
				startDate:this.formatTimeToStr(new Date(),'yyyy-MM') ,
				endDate:this.formatTimeToStr(new Date(),'yyyy-MM') ,
				recordType:0,
				uploadData: {
					recordType:0,
					startDate:this.formatTimeToStr(new Date(),'yyyy-MM') ,
		...
		methods: {
			...
			queryPage() {
				...
				this.axios.post('/perTaxToolTwo/hrEmpInfo/getHrEmpFlowSituationStatisticalTable', params)
					.then(res => {
						this.loading = false;
