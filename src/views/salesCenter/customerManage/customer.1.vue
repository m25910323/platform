	...
	<div class="main_contain">
		<div class="left_contain">
			...
			<div class="contain_body">
				<el-button class='muldel' type="danger" size='mini' style='margin-bottom: 0.2rem;' @click='add'>新建</el-button>
		...
		<el-dialog :title="tag == 0 ? '审核会计配置（新增）' : '审核会计配置（修改）'" :visible.sync="dialogVisible" width="1020px" class='dialog' :close-on-click-modal='false'>
